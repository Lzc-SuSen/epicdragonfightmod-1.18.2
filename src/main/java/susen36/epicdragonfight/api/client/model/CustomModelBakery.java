...
import susen36.epicdragonfight.api.utils.math.Vec2f;
...
public class CustomModelBakery {
	...
	public static void exportModels(File resourcePackDirectory) throws IOException {
		...
		for (Map.Entry<ResourceLocation, ClientModel> entry : BAKED_MODELS.entrySet()) {
			...
			out.closeEntry();
			EpicDragonFight.LOGGER.info("Exported custom armor model : " + entry.getKey());
		}
	...
	abstract static class ModelBaker {
		public abstract void bakeCube(PoseStack poseStack, Cube cube, List<CustomArmorVertex> vertices, List<Integer> indices);
	}
